...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Open a stream but don't close <span class="badge badge-primary badge-pill"  data-toggle="tooltip" data-placement="right" title="number of memory leaks">${openStreamCount} + ${leakCount} (${leakSize})</span></h5>
            <form id="form" action="/openstream">
                <div class="form-group form-check">
                    <input class="form-check-input" type="checkbox" id="store" name="store" ${storeChecked}>
                    <label class="form-check-label" for="store" data-toggle="tooltip" data-placement="right" title="to generate extra memory leak">store to static</label>
                </div>
                <div class="form-group form-check">
